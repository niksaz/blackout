...
public final class Particles {
     ...
     */
    public static Optional<ParticleEffect> getOriginal(GameContext context, String path) {
     ...
     */
    public static Optional<ParticleEffect> getCopy(GameContext context, String path) {
